...
int main(void)
{
	...
	if(users==2)
	{
	printf("\t\t\t\t\t\t\t\t\tUser ID's: Hassan: 191292, Ibrahim: 190312, Hamza: 190189\n\n\t\t\t\t\t\t\t\t\t\t\tEnter user ID: ");scanf("%d",&user);
	system("cls");
	switch(user)
	{
		case 191292:
			
			jamil = fopen("basic info.txt","r");
			char hassan[100];
	
				while(!feof(jamil))
				{		
					fgets(hassan,100,jamil);
					puts(hassan);
				}					
			fclose(jamil);
			jump:
			...
			scanf("%d",&option);
			{
				if(option==1)
				{
						...
						if(meal==1||meal==8||meal==15||meal==22)
							{system("cls");
							day1();}
						else if(meal==2||meal==9||meal==16||meal==23)
							{system("cls");
							day2();}
						else if(meal==3||meal==10||meal==17||meal==24)	
							{system("cls");
							day3();}
						else if(meal==4||meal==11||meal==18||meal==25)
							{system("cls");
							day4();}
						else if(meal==5||meal==12||meal==19||meal==26)
							{system("cls");
							day5();}	
						else if(meal==6||meal==13||meal==20||meal==27)
							{system("cls");
							day6();}
						else if(meal==7||meal==14||meal==21||meal==28)
							{system("cls");
							day7();}
						else if(meal==0||meal>28)
							goto jump;	
						}
					}
					else if(option==2)
					{
						...
						setjmp(buf);
						puts("\t\t\t\t\t\t\t\t\t\t    ***Enter 0 to exit***");
						printf("\t\t\t\t\t\t\t\t\t\t    Select workout plan day: ");scanf("%d",&work);
						choose=work;
						system("cls");
						switch(work)
						{			
	    ...
	    case 190189: 
			...
			switch(option){
					case 1:
						...
						if(mealp==1||mealp==8||mealp==15||mealp==22)
							{system("cls");
							daY1();}
						else if(mealp==2||mealp==9||mealp==16||mealp==23)
							{system("cls");
							daY2();}
						else if(mealp==3||mealp==10||mealp==17||mealp==24)
							{system("cls");
							daY3();}
						else if(mealp==4||mealp==11||mealp==18||mealp==25)
							{system("cls");
							daY4();}
						else if(mealp==5||mealp==12||mealp==19||mealp==26)
							{system("cls");
							daY5();}
						else if(mealp==6||mealp==13||mealp==20||mealp==27)	
							{system("cls");
							daY6();}
						else if(mealp==1||mealp==14||mealp==21||mealp==28)
							{system("cls");
							daY7();}
						else if(mealp==0||mealp>28)
							goto jmp;	
						}
					break;
					case 2:
	...
	FILE * fpointer;
	if((fpointer=fopen("new user.txt","w"))==NULL)
		{
...
{
	FILE *day5;
	day5 = fopen("day 5.txt","r");
			char daythree[500];
	
				while(!feof(day5))
				{		
					fgets(daythree,500,day5);
					puts(daythree);
				}					
			fclose(day5);
}
